...
local RaidSections = {
    ...
    { Name = "Room 2", Points = { {Type = "Move", Pos = Vector3.new(-346.37, 109.14, -5706.03)}, {Type = "Move", Pos = offset(Vector3.new(-346.37, 109.14, -5706.03), 10, -10)}, {Type = "Move", Pos = Vector3.new(-297.09, 109.14, -5722.50)}, {Type = "Move", Pos = offset(Vector3.new(-297.09, 109.14, -5722.50), -10, 10)}, {Type = "Move", Pos = Vector3.new(-301.86, 109.14, -5674.80)}, {Type = "Move", Pos = offset(Vector3.new(-301.86, 109.14, -5674.80), 20, 0)}, {Type = "Move", Pos = Vector3.new(-320, 109.14, -5700)}, } },
    { Name = "Room 3", Points = { {Type = "Move", Pos = Vector3.new(-193.19, 109.14, -5701.66)}, {Type = "Move", Pos = Vector3.new(-147.92, 109.14, -5698.76)}, {Type = "Move", Pos = offset(Vector3.new(-147.92, 109.14, -5698.76), 20, 30)}, {Type = "Move", Pos = offset(Vector3.new(-147.92, 109.14, -5698.76), -25, -10)}, {Type = "Interact", Pos = Vector3.new(-142.38, 109.14, -5771.87)}, {Type = "Move", Pos = Vector3.new(-139.42, 109.02, -5950.68)}, {Type = "Move", Pos = offset(Vector3.new(-139.42, 109.02, -5950.68), 30, 30)}, {Type = "Move", Pos = offset(Vector3.new(-139.42, 109.02, -5950.68), -30, -30)}, {Type = "Move", Pos = offset(Vector3.new(-139.42, 109.02, -5950.68), 30, -30)}, {Type = "Move", Pos = offset(Vector3.new(-139.42, 109.02, -5950.68), -30, 30)}, {Type = "Move", Pos = offset(Vector3.new(-139.42, 109.02, -5950.68), 0, 45)}, } },
...
local function moveTo(pos)
    ...
    local tween = TweenService:Create(root, TweenInfo.new((root.Position - pos).Magnitude / MOVE_SPEED, Enum.EasingStyle.Linear), {CFrame = CFrame.new(pos)})
    tween:Play()
